...
@php
  ...
  $defaultFont  = $pageSettings['defaultFontFamily'] ?? 'Spectral, serif';
...
<head>
  ...
  @php
    // Fontes usadas pelo documento: resolvidas exclusivamente via fontconfig
    // do sistema (arquivos instalados em /usr/local/share/fonts/pdfblock
    // pelo Dockerfile.browserless → install-fonts.sh). Nenhum <link> externo
    // é emitido — zero tráfego de rede para carregamento de fontes.
    //
    // Se uma família usada pelo documento não estiver instalada, o Chromium
    // cai no fallback genérico (serif/sans-serif/monospace) declarado no
    // font-family CSS.
  @endphp
  <style>
