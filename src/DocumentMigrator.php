...
class DocumentMigrator
{
    ...
    private static function migrateStructure(array $st): array
    {
        if (($st['variant'] ?? null) === 'banner') {
            ...
            if (isset($st['repeat'])) $group['repeat'] = $st['repeat'];
            return [$group];
        }
        ...
        if (
            ...
            && self::isTrivialMeta($st['meta'] ?? null) && !isset($st['repeat'])
        ) {
        ...
        if (isset($st['repeat'])) $columnSet['repeat'] = $st['repeat'];
        return [$columnSet];
    }
    ...
    private static function migrateStripe(array $stripe): array
    {
        ...
        if (isset($stripe['repeat'])) $group['repeat'] = $stripe['repeat'];
        return [$group];
    }
    ...
    private static function columnSetToStructure(array $cs, callable $gen): array
    {
        ...
        if (isset($cs['repeat'])) $st['repeat'] = $cs['repeat'];
        return $st;
    }
    ...
    private static function groupToStructure(array $g, callable $gen): array
    {
        ...
        if (isset($g['repeat'])) $st['repeat'] = $g['repeat'];
